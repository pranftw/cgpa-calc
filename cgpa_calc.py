...
st.markdown("**1. Select the number of subjects excluding the non-credit subjects.<br>2. Select the number of credits registered for.<br>3. Enter the CIE (Continuous Internal Evaluation) marks out of 50. [Integer]<br>4. Enter the SEE (Semester End Examination) marks out of 100. [Integer]**",unsafe_allow_html=True)
